...
?>
<div class="container">
  <h1 align=center>Admininistrator Homepage: Oyo State General Hospital </h1>
  ...
  <ul class="nav nav-tabs">
    ...
    <li><a data-toggle="tab" href="#menu1">Doctor Information</a></li>
    <li><a data-toggle="tab" href="#menu2">Clerk Information</a></li>
  </ul>
